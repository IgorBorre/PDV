...
namespace PDV
{
    public partial class ConsultaCancelamentoEntrada : Form
    {
        public ConsultaCancelamentoEntrada()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            DataTable dt;
            dt = produtoDAO.ListarProdutos(c);
        ...
        private void ConsultaCancelamentoEntrada_Load(object sender, EventArgs e)
        {
