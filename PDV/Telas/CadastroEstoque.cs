...
namespace PDV
{
    public partial class CadastroEstoque : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            c = "select codigo, referencia, descricao, estoque, preco from produtos where 1" + produtoDAO.Criterios(TfCodigo.Text, TfReferencia.Text, TfDescricao.Text, TfGrupo.Text);
